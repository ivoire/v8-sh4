...
#ifndef V8_SH4_CODE_STUBS_SH4_H_ // FILE: DIFFWITH: arm, REVIEWEDBY: CG
...
class RecordWriteStub: public PlatformCodeStub {
 public:
  ...
  static void PatchBranchIntoNop(MacroAssembler* masm, int pos) { // REVIEWEDBY: CG
  ...
  static void PatchNopIntoBranch(MacroAssembler* masm, int pos) { // REVIEWEDBY: CG
  ...
  static Mode GetMode(Code* stub) { // REVIEWEDBY: CG
  ...
  static void Patch(Code* stub, Mode mode) { // REVIEWEDBY: CG
 ...
 private:
  ...
  class RegisterAllocation {
   public:
    ...
    void SaveCallerSaveRegisters(MacroAssembler* masm, SaveFPRegsMode mode) { // REVIEWEDBY: CG
    ...
    inline void RestoreCallerSaveRegisters(MacroAssembler*masm,
                                           SaveFPRegsMode mode) { // REVIEWEDBY: CG
      if (mode == kSaveFPRegs) {
