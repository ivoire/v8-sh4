 ...
 * for more details.
 */
/*COMMENTED(#include <linux/kernel.h>*/
/*COMMENTED(#include <linux/string.h>*/
/*COMMENTED(#include <linux/uaccess.h>*/

#if !defined(V8_TARGET_ARCH_SH4) || defined(V8_IN_TYPE_DECLS)
...
typedef enum {
        ...
        IMM_8, IMM_8BY2, IMM_8BY4/*COMMENTED(,)*/
} sh_nibble_type;
...
typedef enum {
        ...
        XMTRX_M4,
        F_FR0,
        FPUL_N, FPUL_M, FPSCR_N, FPSCR_M/*COMMENTED(,)*/
} sh_arg_type;

static struct sh_opcode_info {
        /*ADDED(*/const/*)*/ char *name;
        sh_arg_type arg[7];
        ...
        {"bf/s",{A_BDISP8},{HEX_8,HEX_F,BRANCH_8}},
        {"clrmac",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_2,HEX_8}},
        {"clrs",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_4,HEX_8}},
        {"clrt",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_0,HEX_8}},
        ...
        {"div0u",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_1,HEX_9}},
        ...
        {"ldtlb",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_3,HEX_8}},
        ...
        {"nop",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_0,HEX_9}},
        ...
        {"rte",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_2,HEX_B}},
        {"rts",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_0,HEX_B}},
        {"sets",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_5,HEX_8}},
        {"sett",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_1,HEX_8}},
        ...
        {"sleep",{/*REPLACED(0,*/A_END/*)*/},{HEX_0,HEX_0,HEX_1,HEX_B}},
        ...
        {"frchg",{/*REPLACED(0,*/A_END/*)*/},{HEX_F,HEX_B,HEX_F,HEX_D}},
        {"fschg",{/*REPLACED(0,*/A_END/*)*/},{HEX_F,HEX_3,HEX_F,HEX_D}},
...
#endif /* !defined(V8_TARGET_ARCH_SH4) || defined(V8_IN_TYPE_DECLS) */
...
#else
void Decoder::print_sh_insn(u32 memaddr, u16 insn)
#endif
{
        int relmask = ~0;
